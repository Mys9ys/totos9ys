            ...
            <div class="match-wrap">
                ...
                <div class="teams-wrap football-shadow-lite info-box forecast-football forecast-box">
                    <div class="home-team relative">
                        ...
                        <input type="number" class="goal-home team-goal float-right football-shadow" min="0" placeholder="...">
                    ...
                    <div class="visit-team relative">
                        ...
                        <input type="number" class="goal-visit team-goal float-left football-shadow" min="0" placeholder="...">
                ...
                <div class="goals-count-wrap forecast-football info-box forecast-box">
                    ...
                    <input type="number" class="goals-margin goals-box float-left goal-count" placeholder="..." data="goals-margin">
                    ...
                    <input type="number" class="goals-sum goals-box float-left goal-count" placeholder="..." data="goals-sum">
                </div>
